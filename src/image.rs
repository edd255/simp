pub mod image {
    ...
    impl Image {
         ...
         *   https://github.com/chris-paterson/PPM
         */
        fn parse_header(lines: &Vec<&str>) -> Option<(String, usize, usize, u8)> {
            let magic_number = lines.get(0).unwrap();
            ...
            return Some((magic_number.to_string(), width, height, scale));
        }
         ...
         *   https://github.com/chris-paterson/PPM
         */
        fn parse_pixels(lines: &Vec<&str>) -> Option<Vec<Pixel>> {
